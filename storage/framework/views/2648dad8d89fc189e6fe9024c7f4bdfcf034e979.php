    ...
    <div class="faq-component">
        ...
        <div class="faq-item">
            ...
            <div class="faq-content">
                <p><?php echo e($settings->sitename); ?> - this is an exciting and provable private mini-games.</p>
        ...
        <div class="faq-item">
            ...
            <div class="faq-content">
                ...
                <p>Each user can check the outcome of any game in a completely deterministic way. Providing a single parameter - the client cache, the inputs of the random number generator, <?php echo e($settings->sitename); ?> can't manipulate the results to his advantage.</p>
                <p>Random number generator <?php echo e($settings->sitename); ?> allows each game to request any number of random numbers from a given client seed, server seed, and one-time number.</p>
            </div>
        </div>
        <div class="faq-item">
            <div class="caption">
            ...
            <div class="faq-content">
                <p>Invite other players to our website at <a class="" href="/affiliate">your referral link</a> and earn <?php echo e($settings->ref_perc); ?>% of our profits with every bet made by your referral.</p>
            </div>
        </div>
    </div>
</div>
