            ...
            <div class="dailyFree_free">
                <div class="form_container">
                    ...
                    <div class="form_info">
                        <div class="form_wrapper group" style="display: none">
                        	<div class="form_text">
								<span>Get to <strong><?php echo e($max); ?> coins for bonus score</strong></span>
                        	</div>
							<div class="form_block">
								<?php if(!$check): ?>
								<div class="form_value"><?php echo e($settings->bonus_group_time); ?> mins<div class="form_text">recharge</div></div>
                        ...
                        <div class="form_wrapper refs" style="display: none">
                        	<div class="form_text">
                        		Invite <strong><?php echo e($settings->max_active_ref); ?> active referrals <div class="popover-tip-block" id="purposeTip"><div class="popover-tip-icon"><svg class="icon icon-help"><use xlink:href="/img/symbols.svg#icon-help"></use></svg></div></div></strong>
                        		<br> and get to <strong><?php echo e($max_refs); ?> coins for bonus score</strong>
                        	</div>
                        	<div class="form_block">
                        		<?php if(!$refLog): ?>
                        		<div class="form_value"><?php echo e($activeRefs); ?> / <?php echo e($settings->max_active_ref); ?><div class="form_text">referral</div></div>
                        		<span id="spin-wheel-button" class=""><button type="button" class="btn" data-toggle="modal" data-target="#captchaModal">Spin</button></span>
                        		<?php else: ?>
                ...
                <div class="list_list">
                    <div class="list_item group" data-bonus="group">
                        ...
                        <div class="list_text"><span>Get to <strong><?php echo e($max); ?> coins for bonus score</strong></span> <span>once a <?php echo e($settings->bonus_group_time); ?> mins</span></div>
                    </div>
                    <div class="list_item refs" data-bonus="refs">
                        <svg class="icon icon-faucet">
                            <use xlink:href="/img/symbols.svg#icon-faucet"></use>
                        </svg>
                        <div class="list_text"><span>Invite <strong><?php echo e($settings->max_active_ref); ?> referral</strong> <br> and get to <strong><?php echo e($max_refs); ?> coins for bonus score</strong></span></div>
                    </div>
