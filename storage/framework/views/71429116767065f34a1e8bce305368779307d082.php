						...
						<div class="game-area">
							<div class="progress-wrap">
								<div class="progress-item left">
									<div class="title">Min Bet: <span id="minBet"><?php echo e($settings->dice_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
									<div class="title">Max Bet: <span id="maxBet"><?php echo e($settings->dice_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
								</div>
							</div>
